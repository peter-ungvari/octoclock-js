define(["jquery", "octojs-clock"], function($, octoclock) {
	...
	/** Visualization of the octal clock. */
	var views = {};
	...
	var render = function() {
		...
		views.timeArcsView.update(octalTime);
		...
		views.textView.update(daysText, hoursText);
	...
	$(function() {
		// construct the views only after the whole document is loaded
		views.timeArcsView = new TimeArcsView();
		views.textView = new TextView();
